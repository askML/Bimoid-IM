...
public class SearchResultsAdapter extends BaseAdapter {
    ...
    public View getView(int arg0, View arg1, ViewGroup arg2) {
        ...
        account.setText(Resources.getSystem().getString(R.string.s_id) + ": " + utilities.filter(info.account_) + "\n" + Resources.getSystem().getString(R.string.s_nick) + ": " + utilities.filter(info.nick_name));
        firstname.setText(Resources.getSystem().getString(R.string.s_name) + ": " + utilities.filter(info.first_name));
        lastname.setText(Resources.getSystem().getString(R.string.s_surname) + ": " + utilities.filter(info.last_name));
        gender.setText(Resources.getSystem().getString(R.string.s_gender) + ": " + utilities.filter(info.gender));
        age.setText(Resources.getSystem().getString(R.string.s_age) + ": " + String.valueOf(info.age_));
