...
public class TransportParams {
    ...
    public static final String translateStatus(int status) {
        switch (status) {
            case 1:
                return Resources.getSystem().getString(R.string.s_status_invisible);
            case 2:
                return Resources.getSystem().getString(R.string.s_status_invisible_for_all);
            case 3:
                return Resources.getSystem().getString(R.string.s_status_ready_for_chat);
            case 4:
                return Resources.getSystem().getString(R.string.s_status_home);
            case 5:
                return Resources.getSystem().getString(R.string.s_status_work);
            case 6:
                return Resources.getSystem().getString(R.string.s_status_lunch);
            case 7:
                return Resources.getSystem().getString(R.string.s_status_away);
            case 8:
                return Resources.getSystem().getString(R.string.s_status_na);
            case 9:
                return Resources.getSystem().getString(R.string.s_status_oc);
            case 10:
                return Resources.getSystem().getString(R.string.s_status_dnd);
        }
        return "";
    }
    ...
    public static final void load(BimoidProfile profile) {
        ...
        for (int i = 0; i < entries.length; i++) {
            ...
            try {
                ...
                if (params.main_status_list == null)
                    throw new Exception("Error occured while loading main statuses for " + params.UUID + " transport");
